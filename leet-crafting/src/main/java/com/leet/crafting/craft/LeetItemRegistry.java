 ...
 * feature can reference any item id. Registered with core as a {@link
 * CustomItemView} so core's /leeta give can look items up without owning the
 * mutable registry.
 */
public final class LeetItemRegistry implements CustomItemView {
